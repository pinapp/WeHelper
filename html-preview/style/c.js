...
function Process(){
  ...
  try{
    if(json == ""){
		$id("Canvas").innerHTML = "<pre>JSON数据格式不正确:\n"+e.message + "</pre>";
	}
...
function ProcessObject(obj, indent, addComma, isArray, isPropertyContent){
  ...
  if(IsArray(obj)){
    if(obj.length == 0){
      ...
      clpsHtml = window.IsCollapsible ? "<span><img src=\""+window.ImgExpanded+"\" onClick=\"ExpImgClicked(this)\" class='expImg' /></span><span class='collapsible'>" : "";
